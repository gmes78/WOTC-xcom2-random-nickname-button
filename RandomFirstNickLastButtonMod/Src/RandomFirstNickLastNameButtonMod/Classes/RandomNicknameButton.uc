...
/*
	...
	This is an XCOM 2 mod that adds five buttons to the UI, which generate respectively:
	 Random first, nick, last names; random country, random biography.

	All of these buttons hook into the in-game generator functions with only the tiniest
